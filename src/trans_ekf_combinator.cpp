...
TransEKFCombinator::TransEKFCombinator(ros::NodeHandle nh)
{
   ...
   imu_sub_ = nh_.subscribe<sensor_msgs::Imu>("/state/imu", 1, &TransEKFCombinator::imuCB, this);
   dvl_sub_ = nh_.subscribe<geometry_msgs::TwistWithCovarianceStamped>("/puddles/dvl/dvl_twist", 1, &TransEKFCombinator::dvlCB, this);
